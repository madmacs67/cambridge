...
<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300italic,400italic,300,600,600italic' rel='stylesheet' type='text/css'>
<style>
.contactUsHome a {
...
<div id="wrapper">
  ...
  <div id="headerContent">
	  <div id="hdrImg">
	  	<img src="images/homePageTempImg_618x305.jpg" alt="homePageTempImg_618x305" width="618" height="305" />
	  </div>
	  <div id="hdrQuoteContainer">
		  	<div class="quote">
			  	Our Mission is to help you create extraordinary educational systems.
		  	</div>
	  </div>
	  <div class="clearFloat"></div>
	  <div id="hdrBottom"></div>
  </div>
